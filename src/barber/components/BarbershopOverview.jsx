...
export default function BarbershopOverview() {
                                ...
                                <fieldset aria-label="Choose a size" className="mt-4">
                                    ...
                                    >
                                        {product.sizes.map((size) => (
                                            ...
                                            >
                                                <span className="text-center font-bold">{size.name}</span>
                                                {size.inStock ? (
                                                    <span
                                                        aria-hidden="true"
                    ...
                    <div
                        ...
                        <div className="mt-10">
                            ...
                            <div className="mt-4 space-y-6">
                                <p className="text-sm text-gray-600 font-bold">Mon - Sun | 10.00 - 22.00</p>
                            </div>
                        </div>
                    </div>
                </div>
