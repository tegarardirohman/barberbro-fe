...
import {checkBarbershopStatus} from "../../utils/utils";
...
export default function NearbyBarber({limit = 0}) {
            ...
            <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-8 lg:max-w-7xl lg:px-8">
                ...
                <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    {currentItems.map((data) => (
                        ...
                        >
                            <div
                                className="w-full aspect-square overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80 relative">
                                <img
