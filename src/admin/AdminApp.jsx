...
import PartnerRequest from "./components/PartnerRequest.jsx";
            ...
            <div className="min-h-full">
                ...
                <header className="bg-white shadow">
                    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900">Hello, Chamomile Tea</h1>
                    </div>
                </header>
                <main>
                    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                        <div className="flex flex-row flex-wrap gap-4">
                            <div>
                                <h2 className='font-bold text-xl'>Transaction Stats</h2>
                                <TransactionChart/>
                            </div>
                            <div>
                                <h2 className='font-bold text-xl'>Customer Stats</h2>
                                <TransactionChart/>
                            </div>
                        </div>
                        <PartnerRequest/>
